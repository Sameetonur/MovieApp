...
INSERT INTO Movies
    (MovieId, CategoryId, MovieName, MovieDuration, AboutMovie, Director, Writer, Star, ImdbPoint, MovieImgURL, MovieURL)
VALUES
    (11, 3, 'Esaretin Bedeli', 142, 'Andy Dufresne, işlemediği bir suçtan dolayı hapse atılır. Shawshank Hapishanesi''nde, Red adlı bir mahkumla dostluk kurar ve birlikte umudu ve özgürlüğü ararlar. Hapisteki zorluklarla başa çıkarken Andy, hayatta kalmanın ve değişimin gücünü keşfeder.', 'Frank Darabont', 'Stephen King, Frank Darabont', 'Tim Robbins', 9, '/ui/img/Filmler/Dram-EsaretinBedeli-1.jpg', 'https://www.youtube.com/embed/6hB3S9bIaco'),
    (12, 3, 'Forrest Gump', 142, 'Forrest Gump, düşük IQ''suna rağmen hayatı boyunca olağanüstü başarılara imza atar. Amerikan tarihinin önemli anlarına tanıklık eden Forrest, saf yüreğiyle hem aşkı hem de hayatın anlamını keşfeder. Hayatı boyunca kendine özgü bir hikaye yaratır.', 'Robert Zemeckis', 'Winston Groom, Eric Roth', 'Tom Hanks', 8, '/ui/img/Filmler/Dram-forrestgump-2.jpg', 'https://www.youtube.com/embed/bLvqoHBptjg'),
    (13, 3, 'Dövüş Kulübü', 139, 'Bir uykusuzluk hastası ve karizmatik bir sabun satıcısı, kurallarını kendilerinin yazdığı bir yeraltı dövüş kulübü kurar. Ancak işler karmaşık bir hal alır ve kontrol ellerinden kayar. Film, kimlik, tüketim kültürü ve toplumsal baskılar üzerine çarpıcı bir hikaye sunar.', 'David Fincher', 'Chuck Palahniuk, Jim Uhls', 'Brad Pitt', 8, '/ui/img/Filmler/Dram-Dovuskulubu-3.jpg', 'https://www.youtube.com/embed/qtRKdVHc-cE'),
...
INSERT INTO Movies
    (MovieId, CategoryId, MovieName, MovieDuration, AboutMovie, Director, Writer, Star, ImdbPoint, MovieImgURL, MovieURL)
VALUES
    (16, 4, 'Cinnet', 146, 'Jack Torrance, ailesiyle birlikte kış boyunca bakıcılık yapmak için Overlook Oteli''ne gider. Ancak otelin karanlık geçmişi, Jack''in akıl sağlığını tehdit eder. Jack, yavaş yavaş deliliğe sürüklenirken ailesi için korku dolu bir hayatta kalma mücadelesi başlar.', 'Stanley Kubrick', 'Stephen King, Stanley Kubrick', 'Jack Nicholson', 8, '/ui/img/Filmler/Korku-Cinnet-1.jpg', 'https://www.youtube.com/embed/5Cb3ik6zP2I'),
    (17, 4, 'Kapan', 104, 'Chris, sevgilisi Rose''un ailesiyle tanışmak için onların malikanesine gider. İlk başta sıcak bir karşılama gibi görünse de, ailedeki gariplikler hızla korkutucu bir hal alır. Chris, bu ortamda saklı olan karanlık sırları keşfeder.', 'Jordan Peele', 'Jordan Peele', 'Daniel Kaluuya', 7, '/ui/img/Filmler/Korku-Kapan-2.jpg', 'https://www.youtube.com/embed/DzfpyUB60YY'),
    (18, 4, 'Elm Sokağında Kabus', 91, 'Freddy Krueger, Elm Sokağı''nda yaşayan gençlerin rüyalarına girerek dehşet saçar. Gençler, Freddy''nin saldırılarından kaçmaya çalışırken rüya ve gerçeklik arasındaki sınırların bulanıklaştığı bir mücadele verir.', 'Wes Craven', 'Wes Craven', 'Heather Langenkamp', 7, '/ui/img/Filmler/Korku-ElmSokKabus-3.jpg', 'https://www.youtube.com/embed/dCVh4lBfW-c'),
    ...
    (20, 4, 'O', 135, 'Derry kasabasındaki çocuklar, kötü bir varlık olan Pennywise''la karşı karşıya gelir. Bu palyaço, korkularıyla beslenirken çocukları hedef alır. Bir grup çocuk, cesaretlerini toplayarak bu korkunç varlığı durdurmaya çalışır.', 'Andy Muschietti', 'Chase Palmer, Cary Joji Fukunaga', 'Bill Skarsgård', 7, '/ui/img/Filmler/Korku-O-5.jpg', 'https://www.youtube.com/embed/xKJmEC5ieOk');
...
VALUES
    ...
    (22, 5, 'Yıldızlararası', 169, 'Dünya yaşanamaz hale gelirken, bir grup kaşif insanlığı kurtarmak için bir solucan deliğinden geçerek bilinmeyene doğru bir yolculuğa çıkar. Film, zaman, sevgi ve fedakarlık temalarını etkileyici bir şekilde işler.', 'Christopher Nolan', 'Jonathan Nolan, Christopher Nolan', 'Matthew McConaughey', 8, '/ui/img/Filmler/BilimKurgu-Yildizlararasi-2.jpg', 'https://www.youtube.com/embed/zSWdZVtXT7E'),
    (23, 5, 'Matrix', 136, 'Neo, sıradan bir hacker olarak yaşarken bir gün gerçek dünyanın çok daha farklı olduğunu keşfeder. İnsanların zihinlerini kontrol eden bir sistemin içinde yaşadığını öğrenir ve bu distopik düzeni değiştirmek için savaşmaya başlar.', 'Lana Wachowski, Lilly Wachowski', 'Lilly Wachowski, Lana Wachowski', 'Keanu Reeves', 8, '/ui/img/Filmler/BilimKurgu-Matrix-3.jpg', 'https://www.youtube.com/embed/vKQi3bBA1y8'),
